...
local RayfieldLibrary = {
    ...
    Topbar = Color3.fromRGB(35, 35, 75),
    Shadow = Color3.fromRGB(10, 10, 30),

    NotificationBackground = Color3.fromRGB(25, 25, 50),
    NotificationActionsBackground = Color3.fromRGB(90, 90, 140),

    TabBackground = Color3.fromRGB(50, 50, 100),
    TabStroke = Color3.fromRGB(85, 85, 120),
    TabBackgroundSelected = Color3.fromRGB(100, 100, 150),
    TabTextColor = Color3.fromRGB(240, 240, 240),
    SelectedTabTextColor = Color3.fromRGB(255, 255, 255),

    ElementBackground = Color3.fromRGB(30, 30, 80),
    ElementBackgroundHover = Color3.fromRGB(50, 50, 120),
    SecondaryElementBackground = Color3.fromRGB(20, 20, 50),
    ElementStroke = Color3.fromRGB(60, 60, 150),
    SecondaryElementStroke = Color3.fromRGB(40, 40, 100),

    SliderBackground = Color3.fromRGB(90, 180, 255),
    SliderProgress = Color3.fromRGB(0, 255, 255),
    SliderStroke = Color3.fromRGB(58, 163, 255),

    ToggleBackground = Color3.fromRGB(30, 30, 50),
    ToggleEnabled = Color3.fromRGB(0, 204, 255),
    ...
    DropdownSelected = Color3.fromRGB(50, 50, 100),
    DropdownUnselected = Color3.fromRGB(30, 30, 70),

    InputBackground = Color3.fromRGB(30, 30, 50),
    InputStroke = Color3.fromRGB(70, 70, 120),
    PlaceholderColor = Color3.fromRGB(150, 150, 255)
		},
